<template>
  <div class="text-xs-center">
    <v-dialog v-model="popup.showUpcomingAbsence" width="1200">
      <v-card>
        ...
        <v-card-text class="card-user">
          ...
          <v-layout v-else row wrap>
            ...
            <v-flex sm12 style="text-align:center" v-if="hasShowMoreUpcoming">
...
export default {
  ...
  props: {
    ...
    hasShowMoreUpcoming: Boolean,
    popup: Object
  },
  methods: {
    viewMore() {
      this.$emit("viewMoreAbsence", "UpcommingAbsence");
    }
  }
};
</script>
